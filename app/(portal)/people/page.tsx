...
export default function PeopleDirectoryPage() {
  ...
  // One grid, ordered by the position list, which runs roughly by seniority.
  //
  // Not grouped under a heading per position: almost every governance position
  // is held by exactly one person, so a section each turned eight people into
  // eight nearly empty rows and a page that had to be scrolled. Ordering
  // carries the same meaning and lets the faces sit together.
