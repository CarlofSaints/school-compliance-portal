...
// Whether a position may be renamed or removed, and if not, why.
//
// Lives here rather than in the route so there is exactly one definition of
// "in use" for both operations, and so it can be tested directly.
